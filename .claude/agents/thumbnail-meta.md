...
**제목 공식 (검증 패턴 — 영상마다 다른 공식 사용, 채널 내 반복 회피):**
| 공식 | 예 |
|---|---|
| 의외 수치 + 질문 | "부산에서 서울까지 12시간, 1592년에 어떻게?" |
| 통념 반전 | "임금님 전화는 큰절부터 했습니다" |
| 금지·단서형 | "교과서가 다루지 않는 그날 밤의 기록" |
| 인물 시점 | "사형 사흘 전, 전화 한 통이 울렸다" |
| 유산 추적 | "지금도 박물관에 남아 있는 그 전화기" |
- 성과 데이터가 쌓이면 mode-improver가 이 표를 갱신한다 (모드의 일부).
