...
| `scripts/` | 결정론적 도구 — `script_mode.py`(대본 모드), `extract_docx.py`(책→텍스트), `produce_video.py`·`make_thumbnail.py`·`fetch_stock.py`(영상), `outlier_score.py`, `yt_subtitles.py`, `upload_youtube.py`, `fetch_analytics.py` |
